...
struct Image::Command {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(f59f6a8579ff1615, 1, 2)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
struct Image::Command::Cmd {
  ...
  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(92d0dc03e793cd6d, 1, 2)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
inline bool Image::Command::Cmd::Reader::isType() const {
  return which() == Image::Command::Cmd::TYPE;
}
inline bool Image::Command::Cmd::Builder::isType() {
  return which() == Image::Command::Cmd::TYPE;
}
inline  ::Image::Command::PrimitiveType Image::Command::Cmd::Reader::getType() const {
  KJ_IREQUIRE((which() == Image::Command::Cmd::TYPE),
              "Must check which() before get()ing a union member.");
  return _reader.getDataField< ::Image::Command::PrimitiveType>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline  ::Image::Command::PrimitiveType Image::Command::Cmd::Builder::getType() {
  KJ_IREQUIRE((which() == Image::Command::Cmd::TYPE),
              "Must check which() before get()ing a union member.");
  return _builder.getDataField< ::Image::Command::PrimitiveType>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void Image::Command::Cmd::Builder::setType( ::Image::Command::PrimitiveType value) {
  _builder.setDataField<Image::Command::Cmd::Which>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS, Image::Command::Cmd::TYPE);
  _builder.setDataField< ::Image::Command::PrimitiveType>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS, value);
}

inline bool Image::Command::Cmd::Reader::isState() const {
  return which() == Image::Command::Cmd::STATE;
}
inline bool Image::Command::Cmd::Builder::isState() {
  return which() == Image::Command::Cmd::STATE;
}
inline bool Image::Command::Cmd::Reader::hasState() const {
  if (which() != Image::Command::Cmd::STATE) return false;
  return !_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline bool Image::Command::Cmd::Builder::hasState() {
  if (which() != Image::Command::Cmd::STATE) return false;
  return !_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline  ::capnp::Text::Reader Image::Command::Cmd::Reader::getState() const {
  KJ_IREQUIRE((which() == Image::Command::Cmd::STATE),
              "Must check which() before get()ing a union member.");
  return ::capnp::_::PointerHelpers< ::capnp::Text>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::capnp::Text::Builder Image::Command::Cmd::Builder::getState() {
  KJ_IREQUIRE((which() == Image::Command::Cmd::STATE),
              "Must check which() before get()ing a union member.");
  return ::capnp::_::PointerHelpers< ::capnp::Text>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void Image::Command::Cmd::Builder::setState( ::capnp::Text::Reader value) {
  _builder.setDataField<Image::Command::Cmd::Which>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS, Image::Command::Cmd::STATE);
  ::capnp::_::PointerHelpers< ::capnp::Text>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline  ::capnp::Text::Builder Image::Command::Cmd::Builder::initState(unsigned int size) {
  _builder.setDataField<Image::Command::Cmd::Which>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS, Image::Command::Cmd::STATE);
  return ::capnp::_::PointerHelpers< ::capnp::Text>::init(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), size);
}
inline void Image::Command::Cmd::Builder::adoptState(
    ::capnp::Orphan< ::capnp::Text>&& value) {
  _builder.setDataField<Image::Command::Cmd::Which>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS, Image::Command::Cmd::STATE);
  ::capnp::_::PointerHelpers< ::capnp::Text>::adopt(_builder.getPointerField(
...
inline ::capnp::Orphan< ::capnp::Text> Image::Command::Cmd::Builder::disownState() {
  KJ_IREQUIRE((which() == Image::Command::Cmd::STATE),
              "Must check which() before get()ing a union member.");
  return ::capnp::_::PointerHelpers< ::capnp::Text>::disown(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
